...
f = urllib.request.urlopen(path, 'r')
...
f = urllib.request.urlopen("https://api.forecast.io/forecast/%s/%s,%s,%s-%s-%sT%s:00:00-0400" % (APIkey,coords[1][1:-1],coords[0][1:-1],YYYY,MM,DD,HH))
